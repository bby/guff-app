...
public final class ServerUtilities {
     ...
     */
    static JSONObject register(final Context context, final String regId)
	...
	for (int i = 1; i <= MAX_ATTEMPTS; i++) {
		...
		try {
			...
			/*
			 * GCMRegistrar.setRegisteredOnServer(context, true); String
			 * message = context.getString(R.string.server_registered);
			 * AppConstants.displayMessage(context, message); return true;
			 */
		} catch (IOException e) {
